	...
	return {
		...
		openAppOfflineStore: function() {
			if (!this.appOfflineStore.store) {
				...
				var data = oResourceModel.getResourceBundle();

				var busyDL = new BusyDialog();
				busyDL.setTitle(data.getText("openOfflineStoreTitle"));
				busyDL.setText(data.getText("openOfflineStoreMessage"));
				busyDL.open();
		 ...
		 * if com.ataway.app.dev.devapp.refreshing is set to true, 
